...
class Node:
    ...
    def gini_best_score(self, y, possible_splits):
        ...
        for p in possible_splits:
            ...
            left_neg = left - leftpos
            right_neg = right - rightpos
            gini_left = 1 - (leftpos/(leftpos + left_neg))**2 - (left_neg/(leftpos + left_neg))**2
            gini_right = 1 - (rightpos/(rightpos + right_neg))**2 - (right_neg/(rightpos + right_neg))**2
